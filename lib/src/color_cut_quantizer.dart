...
class ColorCutQuantizer {
  ...
  static int quantizedRed(int color) {
    return (color >> (__QUANTIZE_WORD_WIDTH + __QUANTIZE_WORD_WIDTH)) &
        __QUANTIZE_WORD_MASK;
  }
  ...
  static int quantizeFromRgb888(int color) {
    ...
    return r << (__QUANTIZE_WORD_WIDTH + __QUANTIZE_WORD_WIDTH) |
        g << __QUANTIZE_WORD_WIDTH |
        b;
  }
...
class VBox {
  ...
  VBox(this._lowerIndex, this._upperIndex, final List<int> colors,
  ...
  int blueComparator(int a, int b) {
    Function swizzle = (int val) {
      return ColorCutQuantizer.quantizedBlue(val) <<
              (ColorCutQuantizer.__QUANTIZE_WORD_WIDTH +
                  ColorCutQuantizer.__QUANTIZE_WORD_WIDTH) |
          ColorCutQuantizer.quantizedGreen(val) <<
              ColorCutQuantizer.__QUANTIZE_WORD_WIDTH |
  ...
  Swatch getAverageColor(final List<int> colors, final List<int> histogram) {
    ...
    int rgb888 =
        ColorCutQuantizer._approximateToRgb888(redMean, greenMean, blueMean);
  ...
  int greenComparator(int a, int b) {
    Function swizzle = (int val) {
      return ColorCutQuantizer.quantizedGreen(val) <<
              (ColorCutQuantizer.__QUANTIZE_WORD_WIDTH +
                  ColorCutQuantizer.__QUANTIZE_WORD_WIDTH) |
          ColorCutQuantizer.quantizedRed(val) <<
              ColorCutQuantizer.__QUANTIZE_WORD_WIDTH |
